...
$select = "SELECT * FROM CatCamionetas WHERE eCodCamioneta = ".$_GET['val'];
...
<div class="row">
    ...
    <form id="datos" name="datos" action="<?=$_SERVER['REQUEST_URI']?>" method="post" enctype="multipart/form-data">
        <input type="hidden" name="eCodCamioneta" id="eCodCamioneta" value="<?=$_GET['val']?>">
        <input type="hidden" name="eAccion" id="eAccion">
                            <div class="col-lg-12">
								<h2 class="title-1 m-b-25"><?=$_GET['val'] ? 'Actualizar ' : '+ '?>Camionetas</h2>
